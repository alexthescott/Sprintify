...
function InfoPane() {
  return (
    <div className="md:ml-20 md:mr-[68px] mx-3 mb-4 transition-all flex flex-col text-white">
      ...
      <div className="mx-auto w-fit flex flex-row h-10 gap-4 items-center justify-center text-center">
        <div>
          ...
          <a href="https://github.com/alexthescott">
            <div
              style={{
                backgroundImage: "url(https://github.com/alexthescott.png)",
        ...
        <div>
          ...
          <a href="https://github.com/Ykrej">
            <div
              style={{
                backgroundImage: "url(https://github.com/Ykrej.png)",
                backgroundSize: "contain",
                width: "5rem",
                height: "5rem",
              }}
